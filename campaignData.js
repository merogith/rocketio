...
export const CAMPAIGN_MISSIONS = [
    {
        ...
        objectivePrimary:
            'Your **Rocket Launchers** are in range — hold position. They will cycle until the enemy **Government** is rubble.',
        objectiveHint:
            'No more inputs needed. If a launcher dies, press **[2]** and rebuild on any owned tile in range.',
    ...
    },
    {
        ...
        objectivePrimary:
            'COUNTER-ATTACK — build **Rocket Launchers (key 2)** on forward tiles and destroy the enemy **Government**.',
        objectiveHint:
            'Tip: 2–3 RLs in range = ~6 volleys to kill an L1 Gov. Keep your Missile Factory alive so they stay fed.',
