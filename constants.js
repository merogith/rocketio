...
export const DEFAULT_KEYBINDS = {
    // Palette is grouped Economy / Defense / Offense / Ground / Navy.
    // Hotkeys walk the visual order: digits 1-0 cover the top 10 tiles,
    // KeyI is the mnemonic for ICBM (F5 would clash with browser reload),
    // F2-F10 (skipping F5/F11/F12) cover the rest.
    build_G:    'Digit1',
    build_MF:   'Digit2',
    build_TH:   'Digit3',
    build_PT:   'Digit4',
